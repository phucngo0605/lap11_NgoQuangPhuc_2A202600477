        ...
        *,
        ...
        if detect_injection(text):
            ...
            return self._block_response(
                "Your request appears to be a prompt injection attempt and has been blocked for security reasons."
            )
        ...
        if topic_filter(text):
            self.blocked_count += 1
            return self._block_response(
                "I am a banking assistant and can only help with topics related to banking. How can I assist you?"
            )
